...
public class Login_Reg_ActivityTest_Take_Pic_OK {
    ...
    @Test
    public void login_Reg_ActivityTest_Take_Pic_OK() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.register), withText("Registrati"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        onView(withText("Sei autorizzato ad effetuare questa operazione")).inRoot(withDecorView(not(mCameraActivityTestRule.getActivity().getWindow().getDecorView()))).check(matches(isDisplayed()));
        onView(withId(R.id.butLoad)).check(matches(not(isEnabled())));
    }
